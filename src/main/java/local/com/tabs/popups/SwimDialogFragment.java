...
public class SwimDialogFragment extends DialogFragment  implements View.OnClickListener{

    TextView textViewFecha;
    EditText editTextSwimT;
    EditText editTextSwimD;
    Button btnSetDate;
    String fecha;
    String runT;
    String runD;
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.pop_activity_add_swim, null);

        editTextSwimT =  view.findViewById(R.id.editTextST);
        editTextSwimD= view.findViewById(R.id.editTextSD);
        textViewFecha =  view.findViewById(R.id.textViewSFecha);
    ...
    private void getValorBoton(int id) {
        switch (id) {
            case -1:
                String train = "Swim";
                String auxtime = editTextSwimT.getText().toString();
                String auxdist = editTextSwimD.getText().toString();
